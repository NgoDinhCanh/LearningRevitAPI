    ...
    public class SolidFace
    {
        ...
        public static PlanarFace GetSouth(Element element)
        {
            ...
            foreach (var item in faceArray)
            {
                ...
                if (x != null)
                {
                    ...
                    bool b2 = x.FaceNormal.AngleTo((-1) * XYZ.BasisY) >= 0 && x.FaceNormal.AngleTo((-1) * XYZ.BasisY) < Math.PI / 4&& x.FaceNormal.AngleTo((-1) * XYZ.BasisX)>Math.PI/4;
        ...
        public static PlanarFace GetNouth(Element element)
        {
            ...
            foreach (var item in faceArray)
            {
                ...
                {
                    bool b1 = PointModel.AreEqual(x.FaceNormal.AngleTo(XYZ.BasisZ), Math.PI / 2);
                    bool b2 = x.FaceNormal.AngleTo( XYZ.BasisY) >= 0 && x.FaceNormal.AngleTo( XYZ.BasisY) < Math.PI / 4 && x.FaceNormal.AngleTo( XYZ.BasisX) > Math.PI / 4;
